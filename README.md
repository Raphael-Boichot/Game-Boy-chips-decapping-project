...
**Please credit authors. Decapping and images made by [Raphaël BOICHOT](https://github.com/Raphael-Boichot), chips donated by [Dorian](https://github.com/dori4n)**
...
I definitely do not recommend doing the process if you are not a skilled chemist (or a skilled [Furrtek](https://github.com/furrtek)). You will probably need some safety equipment (fumehood and individual protection against strong acids). Doing the process bare hand in a backyard with a cooking plate is still a possible option if you like the thrill of danger. Depending on which happy democraty you belong to, just attempting to buy 70% nitric acid will introduce you into some interesting government databases.
