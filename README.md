...
Camera CE10022941, PCB revision 10 - Unknown manufacturer - Chip marking: **MAC-GBD Nintendo 9815 SB** [High resolution here](https://drive.google.com/file/d/1fUm43i4zzt71fiRKpbipy4eYC-yVmNwh/view?usp=sharing). The N.C. pin on the left side is probably intended to trigger the TADD pin of a M64283FP, successor of the M64282FP used with the camera. The current sensor does not need this extra trigger (the corresponding pin, TSW, is not connected on the M64282FP). The N.C. pin on the upper side is probably a RAM_CE1, seeing the proximity with RAM_CE2.
